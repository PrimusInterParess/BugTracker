...
namespace BugTracker.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220323114716_add_relationship-between-organization--department")]
    partial class add_relationshipbetweenorganizationdepartment
    {
            ...
            modelBuilder.Entity("BugTracker.Infrastructure.Data.Models.Priority", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "da0d3b15-b4e4-445a-bf6b-5d4cf58aa015",
                            Name = "low"
                        },
                        new
                        {
                            Id = "0f39183d-d0cf-4306-ab45-7a90fcbb8488",
                            Name = "normal"
                        },
                        new
                        {
                            Id = "c90c7641-49d8-463d-8ba3-89f660de4b2b",
                            Name = "urgent"
                        },
                        new
                        {
                            Id = "40bd0cd3-46b7-4880-b221-eec30e7a8f97",
                            Name = "emergency"
                        });
                });
            ...
            modelBuilder.Entity("BugTracker.Infrastructure.Data.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f9e1618a-473c-4dc2-ad52-e15a3a90a95f",
                            Name = "new"
                        },
                        new
                        {
                            Id = "6f826c9d-9a50-46fa-9b8e-ea353f181579",
                            Name = "in progress"
                        },
                        new
                        {
                            Id = "0cc1828d-8164-41a6-b695-b2a8484fc285",
                            Name = "on hold"
                        },
                        new
                        {
                            Id = "5972bf40-c8bf-4ee0-a8f8-3df39466a185",
                            Name = "solved"
                        },
                        new
                        {
                            Id = "127297d8-3698-470c-b875-2d01418518fe",
                            Name = "closed"
                        });
                });
